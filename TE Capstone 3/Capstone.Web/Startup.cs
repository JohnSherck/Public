    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.Configure<CookiePolicyOptions>(options =>
            {
                ...
                options.CheckConsentNeeded = context => false;  // We had to change this to get our session data to work (saving temperature units preference)
            ...
            services.AddTransient<ISurveyResultDAO, SurveyResultSqlDAO>(d => new SurveyResultSqlDAO(connectionString));
