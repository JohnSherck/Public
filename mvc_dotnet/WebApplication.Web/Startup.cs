...
namespace WebApplication.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IFilmDAO, FilmSqlDAO>(p => new FilmSqlDAO(connectionString));
            services.AddTransient<IShowTimeDAO, ShowTimeSqlDAO>(w => new ShowTimeSqlDAO(connectionString));
            services.AddTransient<IReservationDAO, ReservationSqlDAO>(z => new ReservationSqlDAO(connectionString));
